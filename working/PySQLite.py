...
def unassignedCases():
    results = theCursor.execute("SELECT case_num, date_requested, case_desc FROM cases WHERE forensic_inv IS 'NULL'")
    uc = results.fetchall()
    return uc
...
os.chdir("/Users/ComputerForensicUnit/Documents/Pycharm/ForensicDB/git/")
